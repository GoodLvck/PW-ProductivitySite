...
Feature: Delete subtask
  ...
  Scenario: Deleting a completed subtask does not affect pending count
    Given I am logged in
    And I am on the detail of a task with several subtasks
    And I am on the subtask detail page of a completed subtask
    When I click the floating "Edit" button
    And I click "Delete"
    And I confirm
    Then I am returned to the task detail page
    And the subtask no longer appears in the list
    And the pending subtask count is unchanged
