"""
Django settings for ProductivitySite project.
...
SECRET_KEY = get_env(
    'DJANGO_SECRET_KEY',
    default='django-insecure-dev-only-key' if DEBUG else None,
    required=not DEBUG,
)
...
INSTALLED_APPS = [
    ...
    'productivity_site.apps.ProductivitySiteConfig',
]
...
ROOT_URLCONF = 'ProductivitySite.urls'
...
WSGI_APPLICATION = 'ProductivitySite.wsgi.application'
...
LOGIN_REDIRECT_URL = get_env('DJANGO_LOGIN_REDIRECT_URL', '/')
LOGOUT_REDIRECT_URL = get_env('DJANGO_LOGOUT_REDIRECT_URL', '/')
